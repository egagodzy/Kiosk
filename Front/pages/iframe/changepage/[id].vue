<template>
    <div class="flex w-full min-h-screen bg-orange-500">
        <IframesChangePageChangeSimplePage v-if="data_for_change.pagetype === 'SimplePage'" v-on:ChangeNewPage="changePage"
            :GetData="data_for_change" />
        <IframesChangePageChangeVideoPage v-if="data_for_change.pagetype === 'Video'" v-on:ChangeNewPage="changePage"
            :GetData="data_for_change" />
        <IframesChangePageChangePDFPage v-if="data_for_change.pagetype === 'PDF'" v-on:ChangeNewPage="changePage"
            :GetData="data_for_change" />
        <IframesChangePageChangeImagesPage v-if="data_for_change.pagetype === 'Images'" v-on:ChangeNewPage="changePage"
            :GetData="data_for_change" />
        <IframesChangePageChangeSitePage v-if="data_for_change.pagetype === 'Site'" v-on:ChangeNewPage="changePage"
            :GetData="data_for_change" />
    </div>
</template>
