<template>
    <div class="flex flex-col">
        <form class="flex flex-col" action="">
            ...
            <input class="flex mx-5 my-5 text-center" type="text" v-model="data_for_save.pagetitle" placeholder="Заголовок">
            <textarea class="flex mx-5 my-5 min-h-[300px]" v-model="data_for_save.pagebody" placeholder="Текст" />
