<template>
    <div class="flex flex-col w-full pb-[40px]">
        <form class="flex flex-col mx-auto w-full" action="">
            ...
            <input type="file" class="flex w-4/5 mx-auto mt-10 bg-blue-500" accept="application/pdf"
        ...
        async ChangePage() {
            ...
            if (this.currentpagename === this.data_for_change.pagename) {
                ...
                if (this.testG.length === 0) {
                    this.ErrorPageName = "Добавьте PDF файл.";
                } else {
                                                                ...
                                                                .then(response => {
                                                                    axios.post("http://localhost:1337/UploadIcon", this.formIcon, {
                                                                        ...
                                                                        .then(response => {
                                                                            ...
                                                                            //console.log(response.data.IconSRC);
                                                                            if (!this.NewValue.includes('blob')) {
                                                                                axios.post("http://localhost:1337/delete_pdf", { "pdfsrc": this.NewValue.replaceAll(this.currentpagename, this.data_for_change.pagename) })
